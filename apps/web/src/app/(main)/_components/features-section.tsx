            ...
            >
              <SpotlightCard glow={feature.glow} className="h-full">
                <Link href={feature.href} className="flex h-full flex-col p-7">
                  <div className="mb-5 flex size-11 items-center justify-center rounded-xl border border-white/10 bg-white/5 text-emerald-300 transition-colors duration-300 group-hover:border-emerald-400/40 group-hover:text-emerald-200">
                  ...
                  <span className="mt-auto inline-flex items-center gap-1.5 pt-6 text-sm font-medium text-neutral-300 transition-colors group-hover:text-emerald-200">
                    {feature.cta}
