-- Drop the dead codelet.type column and its enum.
--
-- Frontend-only scope means every codelet is implicitly "web"; the column was
...
BEGIN;
DROP TYPE IF EXISTS codelet_type;
COMMIT;
